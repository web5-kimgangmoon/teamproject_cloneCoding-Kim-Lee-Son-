...
import BoardLikeDislikeModel from "./board/BoardLikeDislike.js";
...
import ChannelImgsModel from "./channel/ChannelImg.js";
...
export const BoardLikeDislike = BoardLikeDislikeModel.init(sequelize);
...
export const ChannelImg = ChannelImgsModel.init(sequelize);
export const Channel = ChannelsModel.init(sequelize);

export const User = UserModel.init(sequelize);

const db = { Board, BoardLikeDislike, Comment, Category, ChannelAdmin, ChannelImg, Channel, User };
// const db = {};
